...
export default function CartPage() {
    ...
    const handleCheckout = () => {
        ...
        const message = `হ্যালো রূপান্তর,\nআমি একটি অর্ডার করতে চাই:\n\n${productList}\n\n${total}\n\nধন্যবাদ!`
        const encodedMessage = encodeURIComponent(message)

        // Merchant Phone Number (Replace with actual number)
        const phoneNumber = "8801700000000" // Example number
                ...
                <div className="lg:col-span-4">
                    <div className="rounded-lg border bg-card p-6 shadow-sm sticky top-24">
                        ...
                        <Button className="w-full mt-8 rounded-full h-12 text-lg font-medium" onClick={handleCheckout}>
                            চেকআউট করুন (WhatsApps) <ArrowRight className="ml-2 h-4 w-4" />
                        </Button>

                        <p className="text-xs text-center text-muted-foreground mt-4">
                            চেকআউট বোতামে ক্লিক করলে আপনাকে হোয়াটসঅ্যাপে রিডাইরেক্ট করা হবে।
                        </p>
                    </div>
                </div>
            </div>
